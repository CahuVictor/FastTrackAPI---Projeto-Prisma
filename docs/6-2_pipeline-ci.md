...
| 9️⃣ | **Pytest + coverage**     | `poetry run pytest --cov=app --cov-report=xml --cov-report=term-missing --cov-report=html --cov-fail-under=80` | Garante cobertura mínima           |
...
| **Pytest**    | Testes        | `poetry run pytest -x --cov=app --cov-report=xml --cov-report=term-missing --cov-report=html --cov-fail-under=80` |
...
poetry run pytest -x --cov=app --cov-report=xml --cov-report=term-missing --cov-report=html --cov-fail-under=80
```
