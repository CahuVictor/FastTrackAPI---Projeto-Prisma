...
from app.schemas.event.event_update import EventUpdate, LocalInfoUpdate, ForecastInfoUpdate
from app.schemas.forecast.forecast_create import ForecastInfoResponse
