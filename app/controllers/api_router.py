...
from app.controllers import event_controller, local_controller, event_audit_controller, event_relation_controller, user_controller  # , auth, events, users, admin_urls
